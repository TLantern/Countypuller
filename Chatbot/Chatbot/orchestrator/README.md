...
```bash
cd Chatbot/Chatbot/orchestrator
...
python ../PullingBots/HarrisTX.py
python ../PullingBots/tools/hcad_lookup.py
python cache.py
```

## Integration with Frontend

Once the orchestrator system is working, it can be integrated with the Next.js frontend:
